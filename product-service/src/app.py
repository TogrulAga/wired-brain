...
def get_database_url():
    ...
    with open('/run/secrets/db_password') as file:
...
# curl --header "Content-Type: application/json" --request PUT --data '{"name": "Updated Product 2"}' -v http//localhost:5000/product
